...
case INSTR_INSERTCONNECTORSINNULL:{
  ...
  print_indent(indent); printf("    warry_set(rc, %d, insertconnectors(rc, NULL, &v), 0, TT_OTHER);\n", (int)targ0);
    {
...
case INSTR_INSERTCONNECTORS:{
  ...
  print_indent(indent); printf("  {\n");
  print_indent(indent); printf("    const Vector v = vec_const_temporary_from_array(targ1_num, targ1);\n");
  print_indent(indent); printf("    warry_set(rc, %d, insertconnectors(rc, (LmnMembrane *)wt(rc, %d), &v), 0, TT_OTHER);\n", (int)targ0, (int)targ2);
    {
      char *buf_always = automalloc_sprintf("goto label_always_%p", op_address);
      instr = translate_instructions(instr, jump_points, header, buf_always, buf_always, indent+1);
      free(buf_always);
...
case INSTR_COMMIT:{
  ...
  print_indent(indent); printf("  {\n");
  print_indent(indent); printf("    LmnMembrane *ptmp_global_root;\n");
  print_indent(indent); printf("    LmnRegister *v;\n");
...
case INSTR_FINDATOM:{
  ...
  print_indent(indent); printf("    {\n");
  print_indent(indent); printf("      AtomListEntry *atomlist_ent = lmn_mem_get_atomlist((LmnMembrane*)wt(rc, %d), TR_GFID(%d));\n", (int)targ1, targ2.functor_data);
  ...
  print_indent(indent); printf("            wt_set(rc, %d, atom);\n", (int)targ0);
...
case INSTR_LOCKMEM:{
  ...
  print_indent(indent); printf("  warry_set(rc, %d, LMN_PROXY_GET_MEM(wt(rc, %d)), 0, TT_MEM);\n", (int)targ0, (int)targ1);
  print_indent(indent); printf("  if(((LmnMembrane*)wt(rc, %d))->name != TR_GSID(%d)) %s;\n", (int)targ0, (int)targ2, failcode);
  return instr;
}
case INSTR_ANYMEM:{
  LmnInstrVar targ0;
  ...
  print_indent(indent); printf("  {\n");
  print_indent(indent); printf("    LmnMembrane *mp = ((LmnMembrane*)wt(rc, %d))->child_head;\n", (int)targ1);
  print_indent(indent); printf("    for (; mp; mp=mp->next) {\n");
  print_indent(indent); printf("      warry_set(rc, %d, mp, 0, TT_MEM);\n", (int)targ0);
  print_indent(indent); printf("      if (mp->name == TR_GSID(%d)){\n", (int)targ3);
        {
          char *buf_fail = automalloc_sprintf("goto label_fail_%p", op_address);
          instr = translate_instructions(instr, jump_points, header, successcode, buf_fail, indent+1);
          free(buf_fail);
...
case INSTR_NMEMS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  if (!lmn_mem_nmems((LmnMembrane*)wt(rc, %d), %d)) %s;\n", (int)targ0, (int)targ1, failcode);
  return instr;
}
case INSTR_NORULES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  if (((LmnMembrane *)wt(rc, %d))->rulesets.num) %s;\n", (int)targ0, failcode);
  return instr;
}
case INSTR_NEWATOM:{
  LmnInstrVar targ0;
  ...
  case LMN_DBL_ATTR:
  print_indent(indent); printf("  {\n");
  print_indent(indent); printf("    double *d;\n");
  print_indent(indent); printf("    d = LMN_MALLOC(double);\n");
  print_indent(indent); printf("    *d = %lf;\n", targ2.double_data);
  print_indent(indent); printf("    wt_set(rc, %d, d);\n", (int)targ0);
  print_indent(indent); printf("   }\n");
    break;
  case LMN_STRING_ATTR:
  print_indent(indent); printf("    wt_set(rc, %d, lmn_string_make(lmn_id_to_name(TR_GSID(%d))));\n", (int)targ0, targ2.string_data);
    break;
  default:
  ...
  print_indent(indent); printf("  tt_set(rc, %d, TT_ATOM);\n", (int)targ0);
  print_indent(indent); printf("  lmn_mem_push_atom((LmnMembrane*)wt(rc, %d), wt(rc, %d), %d);\n", (int)targ1, (int)targ0, targ2_attr);
  return instr;
}
case INSTR_NATOMS:{
  LmnInstrVar targ0;
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  if (!lmn_mem_natoms((LmnMembrane*)wt(rc, %d), %d)) %s;\n", (int)targ0, (int)targ1, failcode);
  return instr;
}
case INSTR_NATOMSINDIRECT:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  if (!lmn_mem_natoms((LmnMembrane*)wt(rc, %d), wt(rc, %d))) %s;\n", (int)targ0, (int)targ1, failcode);
  return instr;
}
...
case INSTR_NEWLINK:{
  ...
  print_indent(indent); printf("  lmn_mem_newlink((LmnMembrane *)wt(rc, %d), wt(rc, %d), at(rc, %d), %d, wt(rc, %d), at(rc, %d), %d);\n", (int)targ4, (int)targ0, (int)targ0, (int)targ1, (int)targ2, (int)targ2, (int)targ3);
  return instr;
}
case INSTR_RELINK:{
  LmnInstrVar targ0;
...
case INSTR_UNIFY:{
  ...
  READ_VAL(LmnInstrVar, instr, targ3);
  READ_VAL(LmnInstrVar, instr, targ4);
  print_indent(indent); printf("  lmn_mem_unify_atom_args((LmnMembrane *)wt(rc, %d), LMN_SATOM(wt(rc, %d)), %d, LMN_SATOM(wt(rc, %d)), %d);\n", (int)targ4, (int)targ0, (int)targ1, (int)targ2, (int)targ3);
  return instr;
}
case INSTR_PROCEED:{
  print_indent(indent); printf("  %s;\n", successcode);
...
case INSTR_NEWMEM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ2);
  print_indent(indent); printf("  {\n");
  print_indent(indent); printf("    LmnMembrane *mp = lmn_mem_make();\n");
  print_indent(indent); printf("    lmn_mem_add_child_mem((LmnMembrane*)wt(rc, %d), mp);\n", (int)targ1);
  print_indent(indent); printf("    wt_set(rc, %d, mp);\n", (int)targ0);
...
case INSTR_ALLOCMEM:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  wt_set(rc, %d, lmn_mem_make());\n", (int)targ0);
  print_indent(indent); printf("  tt_set(rc, %d, TT_MEM);\n", (int)targ0);
  return instr;
}
case INSTR_REMOVEATOM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  lmn_mem_remove_atom((LmnMembrane*)wt(rc, %d), wt(rc, %d), at(rc, %d));\n", (int)targ1, (int)targ0, (int)targ0);
  return instr;
}
case INSTR_FREEATOM:{
  LmnInstrVar targ0;
...
case INSTR_REMOVEMEM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  lmn_mem_remove_mem((LmnMembrane *)wt(rc, %d), (LmnMembrane *)wt(rc, %d));\n", (int)targ1, (int)targ0);
  return instr;
}
case INSTR_FREEMEM:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  lmn_mem_free((LmnMembrane*)wt(rc, %d));\n", (int)targ0);
  return instr;
}
case INSTR_ADDMEM:{
  LmnInstrVar targ0;
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  lmn_mem_add_child_mem((LmnMembrane *)wt(rc, %d), (LmnMembrane *)wt(rc, %d));\n", (int)targ0, (int)targ1);
  return instr;
}
case INSTR_ENQUEUEMEM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  if (RC_GET_MODE(rc, REACT_MEM_ORIENTED)) {\n");
  print_indent(indent); printf("    lmn_memstack_push(RC_MEMSTACK(rc), (LmnMembrane *)wt(rc, %d)); /* 通常実行時 */\n", (int)targ0);
  print_indent(indent); printf("  }\n");
  return instr;
}
...
case INSTR_LOADRULESET:{
  ...
  print_indent(indent); printf("  lmn_mem_add_ruleset((LmnMembrane*)wt(rc, %d), lmn_ruleset_from_id(TR_GRID(%d)));\n", (int)targ0, (int)targ1);
  return instr;
}
case INSTR_LOADMODULE:{
  ...
  print_indent(indent); printf("  {\n");
  print_indent(indent); printf("    LmnRuleSet ruleset;\n");
  print_indent(indent); printf("    if ((ruleset = lmn_get_module_ruleset(TR_GSID(%d)))) {\n", (int)targ1);
  print_indent(indent); printf("      lmn_mem_add_ruleset((LmnMembrane*)wt(rc, %d), ruleset);\n", (int)targ0);
  print_indent(indent); printf("    } else {\n");
...
case INSTR_DEREFATOM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ1);
  READ_VAL(LmnInstrVar, instr, targ2);
  print_indent(indent); printf("  warry_set(rc, %d, LMN_SATOM(LMN_SATOM_GET_LINK(wt(rc, %d), %d)), LMN_SATOM_GET_ATTR(wt(rc, %d), %d), TT_ATOM);\n", (int)targ0, (int)targ1, (int)targ2, (int)targ1, (int)targ2);
  return instr;
}
case INSTR_DEREF:{
  LmnInstrVar targ0;
...
case INSTR_FUNC:{
  ...
  print_indent(indent); printf("        if (wt(rc, %d) != %ld) %s;\n", (int)targ0, targ1.long_data, failcode);
        break;
      case LMN_DBL_ATTR:
  print_indent(indent); printf("        if (*(double*)wt(rc, %d) != %lf) %s;\n", (int)targ0, targ1.double_data, failcode);
        break;
      case LMN_STRING_ATTR: {
  print_indent(indent); printf("        LmnString s = lmn_string_make(lmn_id_to_name(TR_GSID(%d)));\n", targ1.string_data);
  print_indent(indent); printf("        if(! lmn_string_eq(s, (LmnString)wt(rc, %d))) %s;\n", (int)targ0, failcode);
...
case INSTR_COPYATOM:{
  ...
  print_indent(indent); printf("  lmn_mem_push_atom((LmnMembrane *)wt(rc, %d), wt(rc, %d), at(rc, %d));\n", (int)targ1, (int)targ0, (int)targ0);
  return instr;
}
case INSTR_EQATOM:{
  LmnInstrVar targ0;
...
case INSTR_NEWLIST:{
  ...
  print_indent(indent); printf("    warry_set(rc, %d, listvec, 0, TT_OTHER);\n", (int)targ0);
    {
      char *buf_success = automalloc_sprintf("goto label_success_%p", op_address);
      char *buf_fail = automalloc_sprintf("goto label_fail_%p", op_address);
...
case INSTR_GETFROMLIST:{
  ...
  print_indent(indent); printf("    {\n");
  print_indent(indent); printf("      LinkObj lo = (LinkObj)vec_get((Vector *)wt(rc, %d), (unsigned int)%d);\n", (int)targ1, (int)targ2);
  print_indent(indent); printf("      warry_set(rc, %d, lo->ap, lo->pos, TT_ATOM);\n", (int)targ0);
  print_indent(indent); printf("      break;\n");
  print_indent(indent); printf("    }\n");
  print_indent(indent); printf("  }\n");
  return instr;
...
case INSTR_COPYGROUND:{
  ...
  print_indent(indent); printf("    ProcessTbl atommap;\n");
  print_indent(indent); printf("    lmn_mem_copy_ground((LmnMembrane*)wt(rc, %d), srcvec, &dstlovec, &atommap);\n", (int)targ2);
  print_indent(indent); printf("    free_links(srcvec);\n");
  ...
  print_indent(indent); printf("    warry_set(rc, %d, retvec, LIST_AND_MAP, TT_OTHER);\n", (int)targ0);
    {
      char *buf_always = automalloc_sprintf("goto label_always_%p", op_address);
      instr = translate_instructions(instr, jump_points, header, buf_always, buf_always, indent+1);
      free(buf_always);
...
case INSTR_REMOVEGROUND:{
  ...
  print_indent(indent); printf("  {\n");
  print_indent(indent); printf("    Vector *srcvec = links_from_idxs((Vector*)wt(rc, %d), rc_warry(rc));\n", (int)targ0);
  print_indent(indent); printf("    lmn_mem_remove_ground((LmnMembrane*)wt(rc, %d), srcvec);\n", (int)targ1);
  print_indent(indent); printf("    free_links(srcvec);\n");
  print_indent(indent); printf("  }\n");
  return instr;
}
...
case INSTR_STABLE:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  if (lmn_mem_is_active((LmnMembrane *)wt(rc, %d))) %s;\n", (int)targ0, failcode);
  return instr;
}
case INSTR_IADD:{
  LmnInstrVar targ0;
...
case INSTR_FADD:{
  ...
  READ_VAL(LmnInstrVar, instr, targ1);
  READ_VAL(LmnInstrVar, instr, targ2);
  print_indent(indent); printf("  double *d = LMN_MALLOC(double);\n");
  print_indent(indent); printf("  *d = *(double *)wt(rc, %d) + *(double *)wt(rc, %d);\n", (int)targ1, (int)targ2);
...
case INSTR_FNEG:{
  ...
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  double *d = LMN_MALLOC(double);\n");
  print_indent(indent); printf("  *d = -*(double *)wt(rc, %d);\n", (int)targ1);
  print_indent(indent); printf("  warry_set(rc, %d, d, LMN_DBL_ATTR, TT_ATOM);\n", (int)targ0);
  return instr;
}
case INSTR_FLT:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  if(!(*(double*)wt(rc, %d) < *(double*)wt(rc, %d))) %s;\n", (int)targ0, (int)targ1, failcode);
  return instr;
}
case INSTR_FLE:{
  LmnInstrVar targ0;
...
case INSTR_SETMEMNAME:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(lmn_interned_str, instr, targ1);
  print_indent(indent); printf("  ((LmnMembrane *)wt(rc, %d))->name = TR_GSID(%d);\n", (int)targ0, (int)targ1);
  return instr;
}
...
case INSTR_REMOVEPROXIES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  lmn_mem_remove_proxies((LmnMembrane *)wt(rc, %d));\n", (int)targ0);
  return instr;
}
case INSTR_INSERTPROXIES:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  lmn_mem_insert_proxies((LmnMembrane *)wt(rc, %d), (LmnMembrane *)wt(rc, %d));\n", (int)targ0, (int)targ1);
  return instr;
}
...
case INSTR_REMOVETOPLEVELPROXIES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  lmn_mem_remove_toplevel_proxies((LmnMembrane *)wt(rc, %d));\n", (int)targ0);
  return instr;
}
...
case INSTR_EQFUNC:{
  ...
  print_indent(indent); printf("    if (*(double*)(wt(rc, %d)) !=\n", (int)targ0);
  print_indent(indent); printf("        *(double*)(wt(rc, %d))) %s;\n", (int)targ1, failcode);
  print_indent(indent); printf("    break;\n");
  print_indent(indent); printf("  default:\n");
  print_indent(indent); printf("    if (wt(rc, %d) != wt(rc, %d)) %s;\n", (int)targ0, (int)targ1, failcode);
  print_indent(indent); printf("    break;\n");
...
case INSTR_MOVECELLS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  lmn_mem_move_cells((LmnMembrane *)wt(rc, %d), (LmnMembrane *)wt(rc, %d));\n", (int)targ0, (int)targ1);
  return instr;
}
case INSTR_REMOVETEMPORARYPROXIES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  lmn_mem_remove_temporary_proxies((LmnMembrane *)wt(rc, %d));\n", (int)targ0);
  return instr;
}
case INSTR_NFREELINKS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  if (!lmn_mem_nfreelinks((LmnMembrane *)wt(rc, %d), %d)) %s;\n", (int)targ0, (int)targ1, failcode);
  return instr;
}
case INSTR_COPYCELLS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ1);
  READ_VAL(LmnInstrVar, instr, targ2);
  print_indent(indent); printf("  wt_set(rc, %d, lmn_mem_copy_cells((LmnMembrane *)wt(rc, %d), (LmnMembrane *)wt(rc, %d)));\n", (int)targ0, (int)targ1, (int)targ2);
  print_indent(indent); printf("  tt_set(rc, %d, TT_OTHER);\n", (int)targ0);
  return instr;
}
...
case INSTR_CLEARRULES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  vec_clear(&((LmnMembrane *)wt(rc, %d))->rulesets);\n", (int)targ0);
  return instr;
}
case INSTR_DROPMEM:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  print_indent(indent); printf("  lmn_mem_drop((LmnMembrane *)wt(rc, %d));\n", (int)targ0);
  return instr;
}
case INSTR_TESTMEM:{
  LmnInstrVar targ0;
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  print_indent(indent); printf("  if (LMN_PROXY_GET_MEM(wt(rc, %d)) != (LmnMembrane *)wt(rc, %d)) %s;\n", (int)targ1, (int)targ0, failcode);
  return instr;
}
case INSTR_IADDFUNC:{
  LmnInstrVar targ0;
