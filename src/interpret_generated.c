...
case INSTR_INSERTCONNECTORSINNULL:{
  ...
  READ_VAL_LIST(instr, targ1);
  {
    ...
    warry_set(rc, targ0, insertconnectors(rc, NULL, &v), 0, TT_OTHER);
  }
  free(targ1);
  break;
}
case INSTR_INSERTCONNECTORS:{
  ...
  {
    const Vector v = vec_const_temporary_from_array(targ1_num, targ1);
    warry_set(rc, targ0, insertconnectors(rc, (LmnMembrane *)wt(rc, targ2), &v), 0, TT_OTHER);
  }
  free(targ1);
  break;
}
...
case INSTR_FINDATOM:{
  ...
  if (LMN_ATTR_IS_DATA(targ2_attr)) {
    ...
    {
      AtomListEntry *atomlist_ent = lmn_mem_get_atomlist((LmnMembrane*)wt(rc, targ1), TR_GFID(targ2.functor_data));
      LmnSAtom atom;
      if (atomlist_ent) {
...
case INSTR_LOCKMEM:{
  ...
  warry_set(rc, targ0, LMN_PROXY_GET_MEM(wt(rc, targ1)), 0, TT_MEM);
  if(((LmnMembrane*)wt(rc, targ0))->name != TR_GSID(targ2)) return FALSE;
  break;
}
case INSTR_ANYMEM:{
  LmnInstrVar targ0;
  ...
  {
    LmnMembrane *mp = ((LmnMembrane*)wt(rc, targ1))->child_head;
    for (; mp; mp=mp->next) {
      warry_set(rc, targ0, mp, 0, TT_MEM);
...
case INSTR_NMEMS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  if (!lmn_mem_nmems((LmnMembrane*)wt(rc, targ0), targ1)) return FALSE;
  break;
}
case INSTR_NORULES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  if (((LmnMembrane *)wt(rc, targ0))->rulesets.num) return FALSE;
  break;
}
case INSTR_NEWATOM:{
  LmnInstrVar targ0;
  ...
  case LMN_STRING_ATTR:
    wt_set(rc, targ0, lmn_string_make(lmn_id_to_name(TR_GSID(targ2.string_data))));
    break;
  default:
  ...
  tt_set(rc, targ0, TT_ATOM);
  lmn_mem_push_atom((LmnMembrane*)wt(rc, targ1), wt(rc, targ0), targ2_attr);
  break;
}
case INSTR_NATOMS:{
  LmnInstrVar targ0;
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  if (!lmn_mem_natoms((LmnMembrane*)wt(rc, targ0), targ1)) return FALSE;
  break;
}
case INSTR_NATOMSINDIRECT:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  if (!lmn_mem_natoms((LmnMembrane*)wt(rc, targ0), wt(rc, targ1))) return FALSE;
  break;
}
...
case INSTR_NEWLINK:{
  ...
  lmn_mem_newlink((LmnMembrane *)wt(rc, targ4), wt(rc, targ0), at(rc, targ0), targ1, wt(rc, targ2), at(rc, targ2), targ3);
  break;
}
case INSTR_RELINK:{
  LmnInstrVar targ0;
...
case INSTR_UNIFY:{
  ...
  READ_VAL(LmnInstrVar, instr, targ3);
  READ_VAL(LmnInstrVar, instr, targ4);
  lmn_mem_unify_atom_args((LmnMembrane *)wt(rc, targ4), LMN_SATOM(wt(rc, targ0)), targ1, LMN_SATOM(wt(rc, targ2)), targ3);
  break;
}
case INSTR_PROCEED:{
  return TRUE;
...
case INSTR_NEWMEM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ2);
  {
    ...
    lmn_mem_add_child_mem((LmnMembrane*)wt(rc, targ1), mp);
    wt_set(rc, targ0, mp);
...
case INSTR_REMOVEATOM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  lmn_mem_remove_atom((LmnMembrane*)wt(rc, targ1), wt(rc, targ0), at(rc, targ0));
  break;
}
case INSTR_FREEATOM:{
  LmnInstrVar targ0;
...
case INSTR_REMOVEMEM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  lmn_mem_remove_mem((LmnMembrane *)wt(rc, targ1), (LmnMembrane *)wt(rc, targ0));
  break;
}
case INSTR_FREEMEM:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  lmn_mem_free((LmnMembrane*)wt(rc, targ0));
  break;
}
case INSTR_ADDMEM:{
  LmnInstrVar targ0;
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  lmn_mem_add_child_mem((LmnMembrane *)wt(rc, targ0), (LmnMembrane *)wt(rc, targ1));
  break;
}
case INSTR_ENQUEUEMEM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  if (RC_GET_MODE(rc, REACT_MEM_ORIENTED)) {
    lmn_memstack_push(RC_MEMSTACK(rc), (LmnMembrane *)wt(rc, targ0)); /* 通常実行時 */
  }
  break;
}
...
case INSTR_LOADRULESET:{
  ...
  lmn_mem_add_ruleset((LmnMembrane*)wt(rc, targ0), lmn_ruleset_from_id(TR_GRID(targ1)));
  break;
}
case INSTR_LOADMODULE:{
  ...
  READ_VAL(lmn_interned_str, instr, targ1);
  {
    ...
    if ((ruleset = lmn_get_module_ruleset(TR_GSID(targ1)))) {
      lmn_mem_add_ruleset((LmnMembrane*)wt(rc, targ0), ruleset);
    } else {
...
case INSTR_DEREFATOM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ1);
  READ_VAL(LmnInstrVar, instr, targ2);
  warry_set(rc, targ0, LMN_SATOM(LMN_SATOM_GET_LINK(wt(rc, targ1), targ2)), LMN_SATOM_GET_ATTR(wt(rc, targ1), targ2), TT_ATOM);
  break;
}
case INSTR_DEREF:{
  LmnInstrVar targ0;
  ...
  if (LMN_ATTR_IS_DATA(targ1_attr)) {
    if (LMN_ATTR_IS_DATA(at(rc, targ0)) && at(rc, targ0) == targ1_attr) {
      ...
      case LMN_INT_ATTR:
        ...
        break;
      case LMN_DBL_ATTR:
        if (*(double*)wt(rc, targ0) != targ1.double_data) return FALSE;
        break;
      case LMN_STRING_ATTR: {
        LmnString s = lmn_string_make(lmn_id_to_name(TR_GSID(targ1.string_data)));
        if(! lmn_string_eq(s, (LmnString)wt(rc, targ0))) return FALSE;
        lmn_string_free(s);
...
case INSTR_COPYATOM:{
  ...
  lmn_mem_push_atom((LmnMembrane *)wt(rc, targ1), wt(rc, targ0), at(rc, targ0));
  break;
}
case INSTR_EQATOM:{
  LmnInstrVar targ0;
...
case INSTR_NEWLIST:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  {
    ...
    warry_set(rc, targ0, listvec, 0, TT_OTHER);
  }
  break;
}
...
case INSTR_GETFROMLIST:{
  ...
  switch (at(rc, targ1)) {
    ...
    {
      LinkObj lo = (LinkObj)vec_get((Vector *)wt(rc, targ1), (unsigned int)targ2);
      warry_set(rc, targ0, lo->ap, lo->pos, TT_ATOM);
      break;
    }
  }
  break;
...
case INSTR_COPYGROUND:{
  ...
  READ_VAL(LmnInstrVar, instr, targ2);
  {
    ...
    ProcessTbl atommap;
    lmn_mem_copy_ground((LmnMembrane*)wt(rc, targ2), srcvec, &dstlovec, &atommap);
    free_links(srcvec);
    /* 返り値の作成 */
    retvec = vec_make(2);
    vec_push(retvec, (LmnWord)dstlovec);
    vec_push(retvec, (LmnWord)atommap);
    warry_set(rc, targ0, retvec, LIST_AND_MAP, TT_OTHER);
  }
  break;
}
case INSTR_REMOVEGROUND:{
  ...
  {
    Vector *srcvec = links_from_idxs((Vector*)wt(rc, targ0), rc_warry(rc));
    lmn_mem_remove_ground((LmnMembrane*)wt(rc, targ1), srcvec);
    free_links(srcvec);
  }
  break;
}
...
case INSTR_STABLE:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  if (lmn_mem_is_active((LmnMembrane *)wt(rc, targ0))) return FALSE;
  break;
}
case INSTR_IADD:{
  LmnInstrVar targ0;
...
case INSTR_FADD:{
  ...
  *d = *(double *)wt(rc, targ1) + *(double *)wt(rc, targ2);
...
case INSTR_FLT:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  if(!(*(double*)wt(rc, targ0) < *(double*)wt(rc, targ1))) return FALSE;
  break;
}
case INSTR_FLE:{
  LmnInstrVar targ0;
...
case INSTR_SETMEMNAME:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(lmn_interned_str, instr, targ1);
  ((LmnMembrane *)wt(rc, targ0))->name = TR_GSID(targ1);
  break;
}
...
case INSTR_REMOVEPROXIES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  lmn_mem_remove_proxies((LmnMembrane *)wt(rc, targ0));
  break;
}
case INSTR_INSERTPROXIES:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  lmn_mem_insert_proxies((LmnMembrane *)wt(rc, targ0), (LmnMembrane *)wt(rc, targ1));
  break;
}
...
case INSTR_REMOVETOPLEVELPROXIES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  lmn_mem_remove_toplevel_proxies((LmnMembrane *)wt(rc, targ0));
  break;
}
...
case INSTR_EQFUNC:{
  ...
  case LMN_INT_ATTR:
    ...
    break;
  case LMN_DBL_ATTR:
    if (*(double*)(wt(rc, targ0)) !=
        *(double*)(wt(rc, targ1))) return FALSE;
    break;
  default:
    if (wt(rc, targ0) != wt(rc, targ1)) return FALSE;
    break;
...
case INSTR_ADDATOM:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  lmn_mem_push_atom((LmnMembrane *)wt(rc, targ0), wt(rc, targ1), at(rc, targ1));
  break;
}
case INSTR_MOVECELLS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  lmn_mem_move_cells((LmnMembrane *)wt(rc, targ0), (LmnMembrane *)wt(rc, targ1));
  break;
}
case INSTR_REMOVETEMPORARYPROXIES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  lmn_mem_remove_temporary_proxies((LmnMembrane *)wt(rc, targ0));
  break;
}
case INSTR_NFREELINKS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  if (!lmn_mem_nfreelinks((LmnMembrane *)wt(rc, targ0), targ1)) return FALSE;
  break;
}
case INSTR_COPYCELLS:{
  ...
  READ_VAL(LmnInstrVar, instr, targ1);
  READ_VAL(LmnInstrVar, instr, targ2);
  wt_set(rc, targ0, lmn_mem_copy_cells((LmnMembrane *)wt(rc, targ1), (LmnMembrane *)wt(rc, targ2)));
  tt_set(rc, targ0, TT_OTHER);
  break;
}
...
case INSTR_CLEARRULES:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  vec_clear(&((LmnMembrane *)wt(rc, targ0))->rulesets);
  break;
}
case INSTR_DROPMEM:{
  LmnInstrVar targ0;
  READ_VAL(LmnInstrVar, instr, targ0);
  lmn_mem_drop((LmnMembrane *)wt(rc, targ0));
  break;
}
case INSTR_TESTMEM:{
  LmnInstrVar targ0;
  ...
  READ_VAL(LmnInstrVar, instr, targ0);
  READ_VAL(LmnInstrVar, instr, targ1);
  if (LMN_PROXY_GET_MEM(wt(rc, targ1)) != (LmnMembrane *)wt(rc, targ0)) return FALSE;
  break;
}
case INSTR_IADDFUNC:{
  LmnInstrVar targ0;
